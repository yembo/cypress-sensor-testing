...
describe('Sensor testing', () => {
    ...
    const recordingFiles = [
        "ios-15-1-iphone-se2-10s-all-good.json",
        "ios-15-1-iphone-se2-10s-all-bad.json",
        "ios-15-1-iphone-se2-15s-bad-10-to-12s.json",
        "android-12-galaxy-s21-10s-all-good.json",
        "android-12-galaxy-s21-10s-all-bad.json",
        "android-12-galaxy-s21-15s-bad-10-to-12s.json"
    ];

    for (const recordingFile of recordingFiles) {
        it(`Should pass recorded motion event tests, scenario: ${recordingFile}`, () => {
